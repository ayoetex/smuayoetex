                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-dark btn-sm btn-edit" data-id="<?= $r['id']; ?>" data-role="<?= $r['role']; ?>">Edit</a>
                                <a href="#" class="btn btn-danger btn-sm btn-delete" data-id="<?= $r['id']; ?>">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <form action="<?= base_url('admin/edit'); ?>" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group-justify">
                        <input type="text" class="form-control" id="edit-role-name" name="role_name" placeholder="Role name" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
