...
<div class="container-fluid">
    ...
    <body>
        <button type="button" id="btnPreview" class="btn btn-primary btn-lg active mb-3" onclick="LoadPdfFromUrl('http://localhost/wpu-login/assets/file/DOC-SISTEM-MANAJEMEN-MUTU.pdf')">
            Preview Document
        </button>
