                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="#" class="btn btn-dark btn-sm btn-edit" data-id="<?= $m['id']; ?>" data-menu="<?= $m['menu']; ?>">Edit</a>
                                <a href="#" class="btn btn-danger btn-sm btn-delete" data-id="<?= $m['id']; ?>">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <form action="<?= base_url('menu/edit'); ?>" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group-justify">
                        <input type="text" class="form-control" id="edit-menu" name="menu" placeholder="Menu name" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
