                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-dark btn-sm editSubmenuButton" data-id="<?= $sm['id']; ?>">Edit</button>
                                <button type="button" class="btn btn-danger btn-sm deleteSubmenuButton" data-id="<?= $sm['id']; ?>">Delete</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
<div class="modal fade" id="deleteSubmenuModal" tabindex="-1" role="dialog" aria-labelledby="deleteSubmenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteSubmenuModalLabel">Delete Confirmation</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    $('.deleteSubmenuButton').on('click', function() {
        const id = $(this).data('id');
        $('#deleteId').val(id);
